				...
				<div class="profile-sidebar">
					...
					<div class="portlet light profile-sidebar-portlet">
						...
						<div class="profile-usermenu">
							<ul class="nav">
								<li><a href="/BanRuou/member/profile"> <i
										class="icon-home"></i> Overview
								</a></li>
								<li class="active"><a href="/BanRuou/member/profile-edit">
								...
								<div class="portlet-body">
									<div class="tab-content">
											...
											<form role="form" action="${edit}" method="post"
												...
												<div class="form-group">
													<label class="control-label">Số điện thoại</label> <input
														type="text" placeholder="${accountdetail.sdt}"
										...
										<div class="tab-pane" id="tab_1_2">
											<c:url value="/member/profile-editimage" var="edit"></c:url>
											<form role="form" action="${edit}" method="post"
												enctype="multipart/form-data">
												<div class="form-group">
													<c:url value="/image?fname=${accountdetail.imageLink}"
