				...
				<div class="profile-sidebar">
					...
					<div class="portlet light profile-sidebar-portlet">
						...
						<div class="profile-userpic">
							<img
								src="<c:url value="/templates/assets/admin/pages/media/profile/profile_user.jpg"/>"
						...
						<div class="profile-usermenu">
							<ul class="nav">
								<li><a href="/BanRuou/member/profile"> <i class="icon-home"></i> Overview
								</a></li>

								<li class="active"><a href="/BanRuou/member/profile"> <i
