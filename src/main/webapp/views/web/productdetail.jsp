	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 mb-5 ftco-animate">
				<c:url value="/image?fname=${detailpro.imageLink}" var="imgUrl"></c:url>
				<a href="" class="image-popup prod-img-bg"><img src="${imgUrl}"
					class="img-fluid" alt="Colorlib Template"></a>
			</div>
			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
				<h3>${detailpro.productName}</h3>
				<div class="rating d-flex">
					...
					<p class="text-left">
						<a href="#" class="mr-2" style="color: #000;">${detailpro.sellAmount}
							<span style="color: #bbb;">Sold</span>
						</a>
					</p>
				</div>
				<p class="price">
					<span>$ ${detailpro.price}</span>
				</p>
				<c:forEach items="${listsell}" var="ls">
					<c:if test="${ls.id==detailpro.sellerId}">
						<p>Shop:${ls.shopName}</p>
					</c:if>
				</c:forEach>
				...
				<div class="row mt-4">
					...
					<div class="w-100"></div>
					<div class="col-md-12">
						<p style="color: #000;">${detailpro.inventory} available</p>
					</div>
				</div>
				<p>
						<a href='' onclick="this.href='/BanRuou/cart-add?pId=${detailpro.productId}&quantity='+document.getElementById('quantity').value" class="btn btn-primary py-3 px-5 mr-2">Add to Cart</a>
				</p>
			</div>
		</div>
			...
			<div class="col-md-12 nav-link-wrap">
				<div class="nav nav-pills d-flex text-center" id="v-pills-tab"
					...
					<a class="nav-link ftco-animate active mr-lg-1" id="v-pills-1-tab"
						...
						aria-controls="v-pills-2" aria-selected="false"></a> <a
			...
			<div class="col-md-12 tab-wrap">
				...
				<div class="tab-content bg-light" id="v-pills-tabContent">
					...
					<div class="tab-pane fade show active" id="v-pills-1"
						...
						<div class="p-4">
							<h3 class="mb-4">${detailpro.productName}</h3>
							<p>${detailpro.description}</p>
						</div>
					</div>
