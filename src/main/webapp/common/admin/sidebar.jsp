	...
	<div class="page-sidebar navbar-collapse collapse">
		...
		<ul class="page-sidebar-menu" data-keep-expanded="false"
			...
			<li class="start active open"><a href="javascript:;"> <i
				...
				<ul class="sub-menu">
					<li><a href="/BanRuou/admin/home"> <i class="icon-home"></i>
							Dasboard page
					</a></li>
				</ul></li>
			<li><a href="javascript:;"> <i class="icon-basket"></i> <span
				...
				<ul class="sub-menu">
					<li><a href="/BanRuou/admin/category"> <i
							class="icon-home"></i> Danh sách danh mục
					</a></li>
					<li><a href="/BanRuou/admin/category/add"> <i
							class="icon-basket"></i> Thêm danh mục
					</a></li>
				</ul></li>
			<li><a href="javascript:;"> <i class="icon-rocket"></i> <span
					class="title">Tài khoản</span> <span class="arrow "></span>
			</a>
				<ul class="sub-menu">
					<li><a href="/BanRuou/admin/account"> Quản lý tài khoản</a></li>

				</ul></li>
			<li><a href="javascript:;"> <i class="icon-diamond"></i> <span
					class="title">Quản lý giỏ hàng</span> <span class="arrow "></span>
			</a>
				<ul class="sub-menu">
					<li><a href="/BanRuou/admin/cart"> General Components</a></li>
				</ul></li>
			...
			<li><a href="javascript:;"> <i class="icon-puzzle"></i> <span
				...
				<ul class="sub-menu">
					<li><a href="/BanRuou/admin/product">Danh sách sản phẩm</a></li>
				</ul></li>
		</ul>
		<!-- END SIDEBAR MENU -->
	</div>
